...
import { validateMeal } from "../middleware/validate";

const router = Router();
const prisma = new PrismaClient();

// Add meal log (with validation)
router.post("/", authenticateToken, validateMeal, async (req: AuthRequest, res: Response): Promise<any> => {
    try {
